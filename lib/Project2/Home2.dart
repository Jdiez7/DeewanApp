...
class _Home2State extends State<Home2> {
  _Home2State({this.accountEmail = 'Hier könnte ihre Mailadresse stehen',
    this.accountName = 'MAX MUSTERMANN'});
                      ...
                      UserAccountsDrawerHeader(
                        ...
                        currentAccountPicture: const CircleAvatar(
                          backgroundImage: NetworkImage(
                              "https://pic.onlinewebfonts.com/svg/img_335286.png"),
                        ),
                        decoration:
